...
//    }
//    
//    City *city = (City *)[NSEntityDescription insertNewObjectForEntityForName:NSStringFromClass([City class]) inManagedObjectContext:self.managedObjectContext];
//    
//    city.name = info[@"name"];
//    city.cityID = info[@"id"];
...
//    
//    city.currentWeather = [self weatherForCityWithInfo:info inManagedObjectContext:self.managedObjectContext];
//    
//    [self saveContext];
//}
//
...
//    
//    NSEntityDescription *entity = [NSEntityDescription entityForName:NSStringFromClass([City class]) inManagedObjectContext:self.managedObjectContext];
